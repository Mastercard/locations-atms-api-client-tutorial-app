...
public class Error {
  ...
  **/
  ...
  @ApiModelProperty(example = "latitude", required = true, value = "The application that generated this error")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "INVALID_INPUT_VALUE", required = true, value = "A unique constant identifying the error case encountered during transaction processing")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Latitude is missing, invalid, or could not be determined from address fields.", required = true, value = "Short description of the ReasonCode field")
  ...
  **/
  ...
  @ApiModelProperty(example = "Latitude is missing, invalid, or could not be determined from address fields.", value = "Description of the issue")
